...
include "kirim.php";
		...
		if (isset($_POST['masuk'])) {
			...
			echo "<tr>";
					echo "<th style='background:yellow'>ID Mobil</th>";
					echo "<th style='background:yellow'>Merk</th>";
					echo "<th style='background:yellow'>Model</th>";
					echo "<th style='background:yellow'>Tipe</th>";
					echo "<th style='background:yellow'>Pintu</th>";
					echo "<th style='background:yellow'>Tahun Produksi</th>";
					echo "<th style='background:yellow'>Negara Pembuat</th>";
					echo "<th style='background:yellow'>Jenis Produksi</th>";
				echo "</tr>";
